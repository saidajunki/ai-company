...
### Creator日報（採点ループ / 当面の北極星指標）

効果測定が弱い初期フェーズでは、Creatorの価値観で採点して学習ループを回す。
...
- 日報に含める最低限:
  ...
  - Creatorに対する相談内容
  - 最近かかったコスト
- Creatorは **0〜100点**（内訳: 面白さ/コスト効率/現実性/進化性 各0〜25）とコメントを返す
- 会社は直近の採点/コメントを次の施策提案・相談内容・実行方針に反映する
