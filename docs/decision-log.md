...
- Date: 2026-02-16
  Decision: 有名になること・収益化を目的として運用する
  Why: 方向性を統一し、施策の合力を作るため
  Scope: ビジョン/運用
  Revisit: 事業方針レビュー時

- Date: 2026-02-16
  Decision: Creatorスコア（0-100）を当面の北極星指標として採用する（面白さ最優先）
  Why: 初期は外部指標が弱く、学習ループを回すための短期KPIが必要なため
  Scope: KPI/運用/タスク選定
  Revisit: 所有オーディエンス等の外部指標が安定したら見直す

- Date: 2026-02-16
  Decision: APIキー/トークン/支払い情報/個人情報などの機微情報は公開しない
  Why: 信頼と継続運用の前提として、漏えいリスクを許容しないため
  Scope: 公開/運用
  Revisit: 公開フローが重すぎる場合は手順を見直す
